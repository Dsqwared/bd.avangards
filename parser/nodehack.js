...
fs.readFile('grepped.json', 'utf8', function (err,data) {
  if (err) {
    return console.log(err);
  }
  var res=sjcl.decrypt('Thu Aug 28 2014 16:09:19 GMT+0300 (EEST)',data);
  fs.writeFile("./decoded.json", res, function(err) {
	    if(err) {
	        console.log(err);
	    } else {
